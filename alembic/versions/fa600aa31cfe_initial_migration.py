...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_event_requests_id'), 'event_requests', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_pending_events_id'), 'pending_events', ['id'], unique=False)
    op.create_table('similar_event_pairs',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_similar_event_pairs_id'), 'similar_event_pairs', ['id'], unique=False)
